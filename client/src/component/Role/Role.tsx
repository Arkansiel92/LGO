...
function Role({name, description, side, max, img, roleArray, author, inGame}: role) {
        ...
        <div className={`col-sm-3 `} data-bs-toggle="tooltip" data-bs-placement="top" title={name + " : " + description}>
            {
                ...
                { 
                    ...
                    ? <div className="div-btn">
                        <div>
                            {
                                author === socket.id && <button className=" mx-1 btn-add" onClick={() => {addRole(name)}}>
                            ...
                            {
                                author === socket.id && <button className="mx-1 btn-delete" onClick={() => {deleteRole(name)}}>
