    ...
    return (
        ...
        !player.isDead && 
            <div style={style} className='position-absolute'>
                <div  onClick={handleSubmit} className="d-flex align-items-center rounded p-1" id="player-banner">
                    {
                ...
                <img src="assets/img/sprites/hat-man/hat-man-idle-1.png" className='mx-auto d-block' alt="" />
            </div>
        }
        </div>
    )
